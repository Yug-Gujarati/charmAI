...
import 'package:charmai/view/subprise_screen.dart';
...
class _OptionsScreenState extends State<OptionsScreen> {
  List<optionModel> getTools(BuildContext context) {
    return [
      ...
      optionModel(title: AppLocalizations.of(context)?.suggesthairstyle ?? 'AI Hair Suggest', image: 'assets/home/face_analyze.webp', description: 'Find your perfect look', screen: const FaceAnalyzer()),
      optionModel(title: AppLocalizations.of(context)?.facebeauty ?? 'Face Beauty', image: 'assets/home/face_buty.webp', description: 'Enhance features naturally', screen: const FaceButyEnhance()),
    ];
  }
    ...
    return CustomeButtomWithImage(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            CustomText(text: tool.title, fontSize: 45, textColor: AppColors.primaryText, width: 350, fontFamily: 'regular', maxline: 2, align: TextAlign.center),
            // Text(
            //   tool.title,
